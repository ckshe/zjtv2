...
export default {
  ...
  'menu.recharge.orderdetails.rechargeDetails': '订单详情(详情)',
  ...
  'menu.recommend.recommenddetails': '推介详情',
  ...
  'menu.export.applicationList.exportapplicationlist': '专家申请审核列表(申请列表)',
  'menu.export.applicationList.locklist': '专家申请审核列表（封号）',
